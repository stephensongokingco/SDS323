...
Using data on the prices and characteristics of houses in Saratoga, New York, we seek to create a predictive model of house prices in the city. It is imporant to note that in our model, we will be excluding land value (which is an observed house characteristic in the data). This is because land value likely would bring endogenieity issues in the model. 
